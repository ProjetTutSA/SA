...
public class SortActivity extends Activity {
	...
	private void launchSearch() {
		...
		if (sortCibleLayout.getVisibility() == View.VISIBLE) {
			intent.putExtra("typecible", 
					((RadioButton) findViewById(R.id.sort_blason)).isChecked());
		}
	...
	private boolean checkInputs() {
		...
		if (sortCibleLayout.getVisibility() == View.VISIBLE) {
			result &= ((RadioButton) findViewById(R.id.sort_blason)).isChecked() ^ ((RadioButton) findViewById(R.id.sort_trispot)).isChecked();
		}
