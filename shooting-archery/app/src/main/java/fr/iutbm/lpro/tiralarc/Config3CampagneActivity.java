...
//        editor.putBoolean("RadioCible24",cible24.isChecked());
    ...
    private boolean checkForm() {
        if(!piquet1.isChecked() && !piquet2.isChecked() && !piquet3.isChecked()){
            ...
            return false;
        }else if(!cible24.isChecked() && !cible12.isChecked() && !isEntrainement){
        ...
        else if(!isEntrainement && (Integer.parseInt(num1erecible.getText().toString())<1 ||Integer.parseInt(num1erecible.getText().toString())>24)){
            makeDialog(getString(R.string.erreur),getString(R.string.volees_error));
            return false;
        }
